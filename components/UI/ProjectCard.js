  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-white p-4 py-12 h-full">
        <h3 className="translate-x-full translate-y-[-100%] group-hover:translate-x-0 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 duration-200 mb-2 text-2xl">
          {title}
        </h3>
        <p className="absolute bottom-10 left-1/2 translate-x-[-50%] translate-y-[200px] group-hover:translate-y-0 duration-200 w-4/5 text-xl">
          {lang}
        </p>
      </div>
    </a>
